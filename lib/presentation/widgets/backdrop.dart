...
class Backdrop extends StatefulWidget {
  ...
  final Widget frontPanelToolbar;
...
class _BackdropState extends State<Backdrop>
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      print(" OpEN PERCENTAGE : $openPercentage");
      print(" Closed PERCENTAGE : $closedPercentage");

      final panelDetailsPosition = Tween<Offset>(
        begin: Offset(0.0, 0.85),
        end: Offset(0.0, 0.0),
      ).animate(_controller.view);
      print("BACKDROP PANEL STATE: $_backdropPanelVisible");
          ...
          children: <Widget>[
            ...
            SlideTransition(
              ...
              child: _BackdropPanel(
                ...
                title: !isOpen ? widget.frontHeader : widget.frontPanelToolbar,
                // titleHeight: widget.frontHeaderHeight,
                titleHeight: !isOpen ? 90: 25,
